...
<div class="hero">
    ...
    <a href="健康飲食推薦清單.html" style="display:inline-block;padding:6px 18px;background:#6b8f71;color:#fff;border-radius:8px;font-size:.82em;font-weight:600;text-decoration:none;transition:opacity .15s" onmouseover="this.style.opacity='.85'" onmouseout="this.style.opacity='1'">健康飲食清單</a>
    {daily_btn}
    </div>
</div>
